...
| Time/Date | Preparation | Activity |
| :--- | :--- | :--- |
| Tues, 8 Sept  3:20PM-6:00PM | <br> -Berry/Fagerjord, “On the Way to Computational Thinking,” [in Drive] <br> -Slater, [Distant Coding in the Digital Humanities](https://anastasiasalter.net/DistantCoding/transcript.html),  <br> -Download [GitHub Desktop](https://desktop.github.com/) <br> -[What is Markdown and Why Should we Use It?](https://www.markdownguide.org/getting-started/) <br> -Register your GitHub username and site name [here](https://docs.google.com/spreadsheets/d/1TfNfTmIdxtou0yzEyqs7Jvytpz_kN2cBSVYjejAdMvk/edit?usp=sharing) | Lab: <br> -Slides: A few global examples of global communities doing digital arts and humanities [in Drive] <br> -[Working on building our course sites](https://daahnyuad.github.io/blog/creating-a-static-siteF26/)  <br> -pushing material to them using Github Desktop  <br> -discussion and practice with Markdown  <br> -[Markdown Preview](https://mv.tools/tools/markdown-preview) OR Markdown Preview in VSC <br> -a [Markdown cheatsheet](https://www.markdownguide.org/cheat-sheet/) <br> -Trying out gentle agentic coding <br> -Slides "Distant Coding" in Drive |
...
**Extra Credit: 24 September** (McMaster U, Canada), "Visualizing Your Data: Creating Effective Plots with ggplot2 in R." Up to 2 points on one assignment. Register [here](https://libcal.mcmaster.ca/event/4049897?hs=a) Guidelines [here](https://djwrisley.github.io/DHS/blog/guidelines-extra-credit/).
{: .notice}

**Extra Credit: 25 September** NYU New York Data Services classes "Introduction to R". Up to 2 points on one assignment. Register [here](https://nyu.libcal.com/event/17490476). Guidelines [here](https://djwrisley.github.io/DHS/blog/guidelines-extra-credit/). Guidelines [here](https://djwrisley.github.io/DHS/blog/guidelines-extra-credit/).
{: .notice}
...
Topic: "Looking at and through the algorithm"
...
Topic: Computer Vision and Historical Images
