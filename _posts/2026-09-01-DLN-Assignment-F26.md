---
title: "Digital Literacy Narrative F26"
...
Then using the following prompt with *three* different models (e.g. Gemini, Claude, GPT) to generate the text, appending them to the same file and labelling the parts as to the model they come from. 

Prompting three different models is a great way of seeing how aware they are of digital arts and humanities practices and different kinds of digital literacy. 

A sample Prompt (feel free to tweak the prompt, but include it in the post): 
...
**Step 1 Due date:** 18 Sept 2026, ungraded. The following two revisions will count 5% each toward the total of 10% for this stepwise assignment.
{: .notice}
...
- First put the three responses together in one .md file, save and commit this to Github.
- Then, rewrite a small handful of details in the generated file to reflect the kind of digital literacies you feel that you have and that you want to work on this semester, adjust the perspective to be a bit your own. Save and commit this. 
...
- After your get the three sample texts, write a small paragraph (100 words or so) comparing them and what the models known about digital arts and humanities. 
